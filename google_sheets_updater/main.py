...
coins = ["bitcoin", "ethereum", "monero", "nano", "polkadot", "loopring",
         ...
         "basic-attention-token", "aave", "ethereum-name-service", "cardano", "tornado-cash", "solana", "dogecoin", "maker", "compound-governance-token", "1inch", "defipulse-index",
         "revest-finance", "frax-share", "frax-price-index-share", ]
